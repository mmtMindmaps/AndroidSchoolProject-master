...
public class VehicleRegister extends AsyncTask<String, Void, Integer> {
    ...
    protected Integer doInBackground(String... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost("http://mindmapstechnologies.com:9000/SvnTracking/mmt/User/AddVehicle");
